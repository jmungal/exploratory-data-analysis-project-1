...
#
# This script outputs Plot 4, as specified in the project instructions
#
...
# Set our plot window to 2x2, allowing for the required 4 graphs
par(mfrow=c(2,2))

# Call our plot functions to create the 4 graphs
with(subpower,{
